...
5) Select the nodes or flowlines from which you want to view the results. You can select multiple nodes or flowlines simultaneously, but it is advised to add a maximum of 20 features to your graph to prevent QGIS from crashing. 
