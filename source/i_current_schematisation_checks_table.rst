.. list-table:: Executed checks
   ...
   * - 0001
     - Error
     - surface_map.connection_node_id refers to a non-existing v2_connection_nodes
   * - 0001
     - Error
   ...
   * - 0002
     - Error
     - control_measure_location.id should be unique
   * - 0002
     - Error
     - control_measure_map.id should be unique
   * - 0002
     - Error
   ...
   * - 0003
     - Error
     - control_measure_location.geom cannot be null
   * - 0003
     - Error
     - control_measure_location.id cannot be null
   * - 0003
     - Error
     - control_measure_map.control_type cannot be null
   * - 0003
     - Error
     - control_measure_map.geom cannot be null
   * - 0003
     - Error
     - control_measure_map.id cannot be null
   * - 0003
     - Error
   ...
   * - 0004
     - Error
     - control_measure_location.code is not of type ['text']
   * - 0004
     - Error
     - control_measure_location.connection_node_id is not of type ['integer']
   * - 0004
     - Error
     - control_measure_location.display_name is not of type ['text']
   * - 0004
     - Error
     - control_measure_location.geom is not of type ['blob']
   * - 0004
     - Error
     - control_measure_location.id is not of type ['integer']
   * - 0004
     - Error
     - control_measure_location.measure_variable is not of type ['text']
   * - 0004
     - Error
     - control_measure_location.tags is not of type ['text']
   * - 0004
     - Error
     - control_measure_map.code is not of type ['text']
   * - 0004
     - Error
     - control_measure_map.control_id is not of type ['integer']
   * - 0004
     - Error
     - control_measure_map.control_measure_location_id is not of type ['integer']
   * - 0004
     - Error
     - control_measure_map.control_type is not of type ['text']
   * - 0004
     - Error
     - control_measure_map.display_name is not of type ['text']
   * - 0004
     - Error
     - control_measure_map.geom is not of type ['blob']
   * - 0004
     - Error
     - control_measure_map.id is not of type ['integer']
   * - 0004
     - Error
     - control_measure_map.tags is not of type ['text']
   * - 0004
     - Error
     - control_measure_map.weight is not of type ['integer', 'numeric', 'real']
   * - 0004
     - Error
   ...
   * - 0004
     - Error
     - dry_weather_flow.dry_weather_flow_distribution_id is not of type ['text']
   * - 0004
     - Error
   ...
   * - 0004
     - Error
     - memory_control.measure_variable is not of type ['text']
   * - 0004
     - Error
   ...
   * - 0004
     - Error
     - model_settings.epsg_code is not of type ['integer']
   * - 0004
     - Error
   ...
   * - 0004
     - Error
     - table_control.measure_variable is not of type ['text']
   * - 0004
     - Error
   ...
   * - 0005
     - Error
     - control_measure_location.geom is an invalid geometry
   * - 0005
     - Error
     - control_measure_map.geom is an invalid geometry
   * - 0005
     - Warning
   ...
   * - 0006
     - Error
     - control_measure_location.geom has invalid geometry type, expected POINT
   * - 0006
     - Error
     - control_measure_map.geom has invalid geometry type, expected LINESTRING
   * - 0006
     - Error
   ...
   * - 0007
     - Error
     - aggregation_settings.flow_variable is not one of ['discharge', 'flow_velocity', 'interception', 'lateral_discharge', 'leakage', 'pump_discharge', 'rain', 'simple_infiltration', 'surface_source_sink_discharge', 'volume', 'waterlevel', 'wet_cross-section', 'wet_surface']
   * - 0007
     - Error
     - control_measure_location.measure_variable is not one of ['discharge', 'velocity', 'volume', 'water_level']
   * - 0007
     - Error
     - control_measure_map.control_type is not one of ['memory', 'table']
   * - 0007
     - Error
   ...
   * - 0007
     - Error
     - memory_control.measure_variable is not one of ['discharge', 'velocity', 'volume', 'water_level']
   * - 0007
     - Error
     - memory_control.target_type is not one of ['v2_channel', 'v2_culvert', 'v2_orifice', 'v2_pipe', 'v2_pumpstation', 'v2_weir']
   * - 0007
     - Error
     - model_settings.friction_averaging is not one of [0, 1]
   * - 0007
     - Error
   ...
   * - 0007
     - Error
     - table_control.measure_variable is not one of ['discharge', 'velocity', 'volume', 'water_level']
   * - 0007
     - Error
     - table_control.target_type is not one of ['v2_channel', 'v2_culvert', 'v2_orifice', 'v2_pipe', 'v2_pumpstation', 'v2_weir']
   * - 0007
     - Error
   ...
   * - 0031
     - Error
     - v2_channel.calculation_type cannot be CalculationType.EMBEDDED, CalculationType.CONNECTED or CalculationType.DOUBLE_CONNECTED when model_settings.dem_file is null
   * - 0041
     - Error
   ...
   * - 0053
     - Warning
     - v2_cross_section_definition.id has a closed cross section definition while NumericalSettings.use_nested_newton is switched off. This gives convergence issues. We recommend setting use_nested_newton = 1.
   * - 0054
     - Warning
   ...
   * - 0107
     - Warning
     - v2_manhole.drain_level cannot be null when using sub-basins (model_settings.manhole_aboveground_storage_area > 0) and no DEM is supplied.
   * - 0108
     - Warning
   ...
   * - 0317
     - Error
     - model_settings.epsg_code may not be NULL if no dem file is provided
   * - 0318
     - Warning
     - if model_settings.epsg_code is NULL, it will be extracted from the DEM later, however, the modelchecker will use ESPG:28992 for its spatial checks
   * - 0319
     - Error
   ...
   * - 0326
     - Error
     - model_settings.use_groundwater_flow in model_settings is set to True but groundwater is empty
   * - 0326
     - Error
     - model_settings.use_groundwater_storage in model_settings is set to True but groundwater is empty
   * - 0326
     - Error
     - model_settings.use_interception in model_settings is set to True but interception is empty
   * - 0326
     - Error
     - model_settings.use_interflow in model_settings is set to True but interflow is empty
   * - 0326
     - Error
     - model_settings.use_simple_infiltration in model_settings is set to True but simple_infiltration is empty
   * - 0326
     - Error
     - model_settings.use_vegetation_drag_2d in model_settings is set to True but vegetation_drag_2d is empty
   * - 0327
     - Error
   ...
   * - 0615
     - Warning
     - dry_weather_flow.dry_weather_flow_distribution_id references a dry_weather_flow_distribution feature that does not exist.
   * - 0615
     - Warning
     - dry_weather_flow_map.connection_node_id references a v2_connection_nodes feature that does not exist.
   * - 0615
     - Warning
     - dry_weather_flow_map.dry_weather_flow_id references a dry_weather_flow feature that does not exist.
   * - 0615
     - Warning
     - surface.surface_parameters_id references a surface_parameters feature that does not exist.
   * - 0615
     - Warning
     - surface_map.connection_node_id references a v2_connection_nodes feature that does not exist.
   * - 0615
     - Warning
     - surface_map.surface_id references a surface feature that does not exist.
   * - 0616
     - Warning
   ...
   * - 0761
     - Error
     - The file in model_settings.dem_file has no CRS.
   * - 0762
     - Error
     - The file in model_settings.friction_coefficient_file has no CRS.
   * - 0763
     - Error
     - The file in interception.interception_file has no CRS.
   * - 0764
     - Error
     - The file in interflow.porosity_file has no CRS.
   * - 0765
     - Error
     - The file in interflow.hydraulic_conductivity_file has no CRS.
   * - 0766
     - Error
     - The file in simple_infiltration.infiltration_rate_file has no CRS.
   * - 0767
     - Error
     - The file in simple_infiltration.max_infiltration_volume_file has no CRS.
   * - 0768
     - Error
     - The file in groundwater.groundwater_impervious_layer_level_file has no CRS.
   * - 0769
     - Error
     - The file in groundwater.phreatic_storage_capacity_file has no CRS.
   * - 0770
     - Error
     - The file in groundwater.equilibrium_infiltration_rate_file has no CRS.
   * - 0771
     - Error
     - The file in groundwater.initial_infiltration_rate_file has no CRS.
   * - 0772
     - Error
     - The file in groundwater.infiltration_decay_period_file has no CRS.
   * - 0773
     - Error
     - The file in groundwater.groundwater_hydraulic_conductivity_file has no CRS.
   * - 0774
     - Error
     - The file in groundwater.leakage_file has no CRS.
   * - 0775
     - Error
     - The file in initial_conditions.initial_water_level_file has no CRS.
   * - 0776
     - Error
     - The file in initial_conditions.initial_groundwater_level_file has no CRS.
   * - 0777
     - Error
     - The file in vegetation_drag_2d.vegetation_height_file has no CRS.
   * - 0778
     - Error
     - The file in vegetation_drag_2d.vegetation_stem_count_file has no CRS.
   * - 0779
     - Error
     - The file in model_settings.dem_file does not use a projected CRS.
   * - 0779
     - Error
     - The file in vegetation_drag_2d.vegetation_stem_diameter_file has no CRS.
   * - 0780
     - Error
     - The file in vegetation_drag_2d.vegetation_drag_coefficient_file has no CRS.
   * - 0780
     - Error
   ...
   * - 0797
     - Warning
     - The file in model_settings.dem_file has no EPSG code or the EPSG code does not match does not match model_settings.epsg_code
   * - 0798
     - Error
   ...
   * - 0800
     - Error
     - v2_grid_refinement.refinement_level must not be greater than model_settings.nr_grid_levels
   * - 0800
     - Error
     - v2_grid_refinement_area.refinement_level must not be greater than model_settings.nr_grid_levels
   * - 0801
     - Error
   ...
   * - 0802
     - Info
     - v2_grid_refinement.refinement_level is equal to model_settings.nr_grid_levels and will therefore not have any effect. Lower the refinement_level to make the cells smaller.
   * - 0802
     - Info
     - v2_grid_refinement_area.refinement_level is equal to model_settings.nr_grid_levels and will therefore not have any effect. Lower the refinement_level to make the cells smaller.
   * - 1101
     - Error
   ...
   * - 1220
     - Error
     - control_measure_location.connection_node_id refers to a non-existing v2_connection_nodes
   * - 1221
     - Error
     - memory_control.target_id refers to a non-existing v2_channel
   * - 1221
     - Error
     - table_control.target_id refers to a non-existing v2_channel
   * - 1222
     - Error
     - memory_control.target_id refers to a non-existing v2_pipe
   * - 1222
     - Error
     - table_control.target_id refers to a non-existing v2_pipe
   * - 1223
     - Error
     - memory_control.target_id refers to a non-existing v2_orifice
   * - 1223
     - Error
     - table_control.target_id refers to a non-existing v2_orifice
   * - 1224
     - Error
     - memory_control.target_id refers to a non-existing v2_culvert
   * - 1224
     - Error
     - table_control.target_id refers to a non-existing v2_culvert
   * - 1225
     - Error
     - memory_control.target_id refers to a non-existing v2_weir
   * - 1225
     - Error
     - table_control.target_id refers to a non-existing v2_weir
   * - 1226
     - Error
     - memory_control.target_id refers to a non-existing v2_pumpstation
   * - 1226
     - Error
     - table_control.target_id refers to a non-existing v2_pumpstation
   * - 1227
     - Error
   ...
   * - 1228
     - Error
     - control_measure_map.control_measure_location_id refers to a non-existing control_measure_location
   * - 1230
     - Error
     - memory_control.measure_variable cannot be null
   * - 1231
     - Error
   ...
   * - 1238
     - Error
     - table_control.measure_variable cannot be null
   * - 1239
     - Error
     - table_control.target_type cannot be null
   * - 1240
     - Error
     - control_measure_map.weight cannot be null
   * - 1241
     - Error
     - control_measure_map.control_measure_location_id cannot be null
   * - 1242
     - Error
     - control_measure_location.connection_node_id cannot be null
   * - 1401
     - Error
   ...
   * - 2003
     - Warning
     - surface_parameters.SurfaceParameter.tags is not a comma seperated list of integers
   * - 2004
     - Warning
   ...
   * - 2007
     - Warning
     - memory_control.ControlMemory.tags is not a comma seperated list of integers
   * - 2007
     - Warning
   ...
   * - 2008
     - Warning
     - table_control.ControlTable.tags is not a comma seperated list of integers
   * - 2009
     - Warning
     - control_measure_location.ControlMeasureLocation.tags is not a comma seperated list of integers
   * - 2009
     - Warning
     - surface_parameters.SurfaceParameter.tags refers to tag ids that are not present in Tags, 
   * - 2010
     - Warning
     - control_measure_map.ControlMeasureMap.tags is not a comma seperated list of integers
   * - 2010
     - Warning
   ...
   * - 2013
     - Warning
     - memory_control.ControlMemory.tags refers to tag ids that are not present in Tags, 
   * - 2014
     - Warning
     - table_control.ControlTable.tags refers to tag ids that are not present in Tags, 
   * - 2015
     - Warning
     - control_measure_location.ControlMeasureLocation.tags refers to tag ids that are not present in Tags, 
   * - 2016
     - Warning
     - control_measure_map.ControlMeasureMap.tags refers to tag ids that are not present in Tags, 