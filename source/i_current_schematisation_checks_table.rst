.. list-table:: Executed checks
   ...
   * - 0007
     - Error
     - physical_settings.use_advection_2d is not one of [0, 1]
   * - 0007
     - Error
   ...
   * - 0052
     - Warning
     - cross_section_location.geom is invalid: the cross-section location should be located on the channel geometry (tolerance = 1.0 m)
   * - 0053
     - Warning
   ...
   * - 0615
     - Warning
     - dry_weather_flow_map.connection_node_id references a connection_node feature that does not exist.
   * - 0615
     - Warning
   ...
   * - 0615
     - Warning
     - surface_map.connection_node_id references a connection_node feature that does not exist.
   * - 0615
     - Warning
   ...
   * - 2030
     - Warning
     - windshielding_1d.Windshielding.tags is not a comma seperated list of integers
   * - 2031
     - Warning
   ...
   * - 2036
     - Warning
     - windshielding_1d.Windshielding.tags refers to tag ids that are not present in Tags, 