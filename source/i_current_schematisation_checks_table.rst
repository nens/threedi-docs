.. list-table:: Executed checks
   ...
   * - 1220
     - Error
     - measure_location.connection_node_id refers to a non-existing v2_connection_nodes
   * - 1221
     - Error
   ...
   * - 2013
     - Warning
     - measure_location.ControlMeasureLocation.tags is not a comma seperated list of integers
   * - 2014
     - Warning
     - dry_weather_flow_distribution.DryWeatherFlowDistribution.tags refers to tag ids that are not present in Tags, 
   * - 2014
     - Warning
     - measure_map.ControlMeasureMap.tags is not a comma seperated list of integers
   * - 2015
     - Warning
   ...
   * - 2019
     - Warning
     - measure_location.ControlMeasureLocation.tags refers to tag ids that are not present in Tags, 
   * - 2019
     - Warning
     - obstacle.Obstacle.tags is not a comma seperated list of integers
   * - 2020
     - Warning
     - measure_map.ControlMeasureMap.tags refers to tag ids that are not present in Tags, 
   * - 2020
     - Warning
