.. list-table:: Executed checks
   ...
   * - 0004
     - Error
     - tag.description is not of type ['text']
   * - 0004
     - Error
     - tag.id is not of type ['integer']
   * - 0004
     - Error
   ...
   * - 0206
     - Warning
     - measure_location.geom does not match the position of the object that measure_location.ControlMeasureLocation.connection_node_id refers to
   * - 0206
     - Warning
     - memory_control.geom does not match the position of the object that memory_control.ControlMemory.target_id refers to
   * - 0206
     - Warning
     - memory_control.geom does not match the position of the object that memory_control.ControlMemory.target_id refers to
   * - 0206
   ...
   * - 0206
     - Warning
     - table_control.geom does not match the position of the object that table_control.ControlTable.target_id refers to
   * - 0206
     - Warning
     - table_control.geom does not match the position of the object that table_control.ControlTable.target_id refers to
   * - 0206
   ...
   * - 0206
     - Error
     - windshielding_1d.geom does not match the position of the object that windshielding_1d.Windshielding.channel_id refers to
   * - 0207
     - Warning
