...
With the development of the new API and creating scenario events, the ability to interact with a simulation has become much more efficient. Users are now able to script against the API (or even create their own client) to have full control over a simulation. Some small examples of this interactions are:
...
- DEM
- controls for discharge coefficient of structures
- controls for pump capacity
- controls for weir crest level
- controls for orifice crest level
...
A minor improvement is the expansion of the flow summary. Which will now also include the inflow mdoel.
