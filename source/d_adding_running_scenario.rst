...
Adding scenario information and running a simulation can be done in :ref:`the Modeller Interface <simulate_api_qgis>` with the 3Di API Client or on :ref:`the 3Di Live Site <simulate_w_live_site>`. 
